...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0002_forumcategory_resource_calendarevent_course_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.CharField(choices=[('technical_manual', 'Manual Técnico'), ('user_guide', 'Guía de Usuario'), ('functional_spec', 'Especificación Funcional'), ('procedure', 'Procedimiento Operativo'), ('other', 'Otro')], max_length=20)),
                ...
                ('status', models.CharField(choices=[('draft', 'Borrador'), ('under_review', 'En Revisión'), ('pending_approval', 'Pendiente de Aprobación'), ('approved', 'Aprobado'), ('approved_with_observations', 'Aprobado con Observaciones'), ('rejected', 'Rechazado'), ('published', 'Publicado')], default='draft', max_length=30)),
                ('version', models.CharField(default='1.0', max_length=20)),
                ('file', models.FileField(blank=True, null=True, upload_to='document_drafts/%Y/%m/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf', 'doc', 'docx'])], verbose_name='Archivo del Documento')),
                ('submitted_at', models.DateTimeField(blank=True, null=True, verbose_name='Fecha de Envío a Revisión')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='document_drafts', to=settings.AUTH_USER_MODEL, verbose_name='Analista Autor')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.department')),
                ('manager', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reviewing_drafts', to=settings.AUTH_USER_MODEL, verbose_name='Gerente Asignado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('decision', models.CharField(choices=[('pending', 'Pendiente'), ('approved', 'Aprobado'), ('approved_with_observations', 'Aprobado con Observaciones'), ('rejected', 'Rechazado')], default='pending', max_length=30)),
                ...
                ('correction_deadline', models.DateField(blank=True, null=True, verbose_name='Plazo para Correcciones')),
                ('rejection_reason', models.TextField(blank=True, verbose_name='Motivo de Rechazo')),
                ('approved_at', models.DateTimeField(blank=True, null=True)),
                ('validity_date', models.DateField(blank=True, null=True, verbose_name='Fecha de Vigencia')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('assistant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assisted_approvals', to=settings.AUTH_USER_MODEL, verbose_name='Asistente Administrativo')),
                ('reviewer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='document_reviews', to=settings.AUTH_USER_MODEL, verbose_name='Gerente Revisor')),
                ('document_draft', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approvals', to='api.documentdraft')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.CharField(choices=[('manual', 'Manual Técnico'), ('procedure', 'Procedimiento'), ('policy', 'Política'), ('guide', 'Guía de Usuario'), ('specification', 'Especificación Funcional'), ('other', 'Otro')], default='manual', max_length=20)),
                ...
                ('status', models.CharField(choices=[('available', 'Disponible'), ('on_loan', 'En Préstamo'), ('archived', 'Archivado'), ('under_review', 'En Revisión')], default='available', max_length=20)),
                ('file', models.FileField(blank=True, null=True, upload_to='technical_documents/%Y/%m/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf', 'doc', 'docx'])], verbose_name='Archivo Digital (opcional)')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('authorized_users', models.ManyToManyField(blank=True, related_name='authorized_documents', to=settings.AUTH_USER_MODEL, verbose_name='Usuarios Autorizados')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_technical_documents', to=settings.AUTH_USER_MODEL)),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='technical_documents', to='api.department')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('requested', 'Solicitado'), ('approved', 'Aprobado'), ('delivered', 'Entregado'), ('returned', 'Devuelto'), ('overdue', 'Vencido'), ('cancelled', 'Cancelado')], default='requested', max_length=20)),
                ('request_date', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Solicitud')),
                ('delivery_date', models.DateTimeField(blank=True, null=True, verbose_name='Fecha de Entrega')),
                ('expected_return_date', models.DateField(blank=True, null=True, verbose_name='Fecha Esperada de Devolución')),
                ('actual_return_date', models.DateTimeField(blank=True, null=True, verbose_name='Fecha Real de Devolución')),
                ...
                ('analyst', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='document_loans', to=settings.AUTH_USER_MODEL, verbose_name='Analista')),
                ('assistant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='processed_loans', to=settings.AUTH_USER_MODEL, verbose_name='Asistente Administrativo')),
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='loans', to='api.technicaldocument')),
            ],
            options={
