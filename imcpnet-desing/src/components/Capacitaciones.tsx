...
export function Capacitaciones({ isAdmin }: CapacitacionesProps) {
    ...
    return (
      <div className="p-8">
        <div className="mb-6">
          ...
          <h1 className="text-gray-900">Asignar Capacitación</h1>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Create Training Form */}
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h2 className="text-gray-900 mb-4">Nueva Capacitación</h2>
            <form className="space-y-4">
              ...
              <div>
                <label className="block text-gray-700 mb-2">Cupo Máximo</label>
                <input
                  type="number"
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          {/* Assign to Employees */}
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h2 className="text-gray-900 mb-4">Asignar Empleados</h2>
  ...
  return (
    <div className="p-8">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-gray-900 mb-2">Capacitaciones</h1>
          ...
          {asignadas.map((capacitacion) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-gray-900 flex-1">{capacitacion.title}</h3>
              ...
              <p className="text-gray-600 mb-4">Instructor: {capacitacion.instructor}</p>
      ...
      {activeTab === 'calendario' && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="mt-6 space-y-3">
            <p className="text-gray-700">Próximos eventos:</p>
            {asignadas.slice(0, 3).map((cap) => (
              <div key={cap.id} className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600">{cap.date} - {cap.time}</p>
                </div>
              </div>
            ))}
          </div>
